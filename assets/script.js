...
var getVideos = function (language) {
    ...
    let maxResults = 10
  let apiUrl = "https://www.googleapis.com/youtube/v3/search?key=" + apiKey + "&type=video&part=snippet&order=viewCount&maxResults=" + maxResults + "&order=viewCount" + "&q=" + language
...
var displayVideos = function(data) {
    ...
    for (var i = 0; i < 10; i++) {
        ...
        var videoContainer = $("#youtube_container")
